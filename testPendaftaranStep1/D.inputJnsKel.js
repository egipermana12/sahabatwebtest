...
/**
 * [jnsKelNotNull description]
 * @return {[type]} [Jenis Kelamin Belum dipilih]
 */
async function jnsKelNotNull()
{
	const inputData = [
    ...
    try{
        ...
        assert.strictEqual(sweetAlertText, "Jenis Kelamin Belum dipilih");
        console.log('Test Jenis Kelamin Not Null passed...');

    }catch(error){
    	console.log('Test Jenis Kelamin Not Null failed...');
...
/**
 * [jnsKelValNotRegis description]
 * @return {[type]} [Jenis Kelamin Tidak Terdaftar]
 */
async function jnsKelValNotRegis()
{
	const inputData = [
        { nohp: '08126547891', tgllahir: '29/12/1993', alamat: 'JL. KOBONG NO. 6', rt: '002', rw: '003'},
    ];
    ...
    try{
        ...
        //untuk ubah value jenis kelamin
        const element = await driver.findElement(By.id("gender-pria"));
        await driver.executeScript("arguments[0].setAttribute('value', '12')", element);
        await driver.sleep(500);
        await element.click();
        ...
        assert.strictEqual(sweetAlertText, "Jenis Kelamin Tidak Terdaftar");
        console.log('Test Jenis Kelamin Not Register passed...');

    }catch(error){
    	console.log('Test Jenis Kelamin Not Register failed...');
    	console.error("Error occurred:", error.message);
    }finally{
    	await driver.sleep(3000);
        await driver.quit();
