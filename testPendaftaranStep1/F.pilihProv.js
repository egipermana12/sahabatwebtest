...
async function valProvNotRegis()
{
	const inputData = [
        { nohp: '08126547891', tgllahir: '29/12/1993', alamat: 'JL. KOBONG NO. 6', rt: '002', rw: '003'},
    ];
    ...
    try{
        ...
        const option = await driver.findElement(By.xpath("//select[@id='fmkode_provinsi']/option[@value='12']"));
        ...
        assert.strictEqual(sweetAlertText, "Provinsi tidak terdaftar");
        console.log('Test Provinsi Not Register passed...');

    }catch(error){
    	console.log('Test Provinsi Not Register failed...');
    	console.error("Error occurred:", error.message);
    }finally{
    	await driver.sleep(3000);
        await driver.quit();
