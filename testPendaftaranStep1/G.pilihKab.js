...
async function pilKabNull()
{
    ...
    try{
        ...
        console.log('Test Kabupaten Not Null passed...');

    }catch(error){
    	console.log('Test Kabupaten Not Null failed...');
...
async function valKabNotRegis()
{
    ...
    try{
        ...
        const option = await driver.findElement(By.xpath("//select[@id='fmkode_kota']/option[@value='03']"));
        ...
        assert.strictEqual(sweetAlertText, "Kabupaten tidak terdaftar");
        console.log('Test Kabupaten Not Register passed...');

    }catch(error){
    	console.log('Test Kabupaten Not Register failed...');
    	console.error("Error occurred:", error.message);
    }finally{
    	await driver.sleep(3000);
        await driver.quit();
