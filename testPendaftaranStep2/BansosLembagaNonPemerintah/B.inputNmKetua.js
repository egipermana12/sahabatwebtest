...
async function nmKetuaNull()
{
    const inputData = [
        {   jnsBantuan: '1', bdnHukum: '2', jnsPenerima: '3',
            nama: 'ABDUL SALAH', ketua: '', no_izin: '012/IZIN/JK',
...
async function nmKetuaNonAlfabet()
{
    const inputData = [
        {   jnsBantuan: '1', bdnHukum: '2', jnsPenerima: '3',
            nama: 'ABDUL SALAH', ketua: '@!@#ABDUL', no_izin: '012/IZIN/JK',
            prov: '12', kab: '03', kec: '03', kel: '1098',
            alamat: 'Jl. Bojong No. 6', rt: '001', rw: '002',
            tgl_profosal: '', judul_profosal: '', latar_belakang: '', maksud_tujuan: 'success',
            dropdownBantuanBerupa: '2', uraian: 'mesin simso'
    ...
    try{
        ...
        assert.strictEqual(sweetAlertText, "Nama Ketua Lembaga hanya diisi alphabet (A s/d Z) dan spasi");
        console.log('Test Nama Ketua Non alphabet passed...');

    }catch(error){
        console.log('Test Nama Ketua Non alphabet failed...');
        console.error("Error occurred:", error.message);
    }finally{
        await driver.sleep(3000);
        await driver.quit();
...
async function nmKetuaTooLong()
{
    ...
    try{
        ...
        assert.strictEqual(sweetAlertText, "Nama Ketua Lembaga terlalu panjang");
        console.log('Test Nama Ketua Too Long passed...');

    }catch(error){
        console.log('Test Nama Ketua Too Long failed...');
        console.error("Error occurred:", error.message);
    }finally{
        await driver.sleep(3000);
        await driver.quit();
