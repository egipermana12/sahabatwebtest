...
async function penHibahNull()
{
    const inputData = [
        {   jnsBantuan: '2', penerimaHibah: '',
    ...
    try{
        ...
        //handle globa form
        await globalFormStep2(driver,inputData, false);
        ...
        assert.strictEqual(sweetAlertText, "Penerima Hibah belum dipilih!");
        console.log('Test Penerima Hibah Not Null passed...');

    }catch(error){
        console.log('Test Pilih Penerima Hibah failed...');
