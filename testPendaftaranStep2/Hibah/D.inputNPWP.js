...
async function npwpNull()
{
    const inputData = [
        {   jnsBantuan: '2', penerimaHibah: '3',
            nminstansi: 'AKATSUKI', nmpimpinan: 'PAIN OZORA',npwp: '', noakta: '01/akta/2022',
    ...
    try{
        ...
        assert.strictEqual(sweetAlertText, "Nomor NPWP belum diisi!");
        console.log('Test NPWP Not Null passed...');

    }catch(error){
        console.log('Test NPWP Not Null failed...');
...
async function npwpNonNumeric()
{
    const inputData = [
        {   jnsBantuan: '2', penerimaHibah: '3',
            nminstansi: 'AKATSUKI', nmpimpinan: 'PAIN OZORA',npwp: '3298989SDEUIDJ3', noakta: '01/akta/2022',
            prov: '12', kab: '03', kec: '03', kel: '1098',
            alamat: 'Jl. Bojong No. 6', rt: '001', rw: '002',
            tgl_profosal: '', judul_profosal: '', latar_belakang: '', maksud_tujuan: 'success',
            dropdownBantuanBerupa: '2', uraian: 'mesin simso'
    ...
    try{
        ...
        assert.strictEqual(sweetAlertText, "Nomor NPWP harus angka");
        console.log('Test NPWP Non Numeric passed...');

    }catch(error){
        console.log('Test NPWP Non Numeric failed...');
        console.error("Error occurred:", error.message);
    }finally{
        await driver.sleep(3000);
        await driver.quit();
...
async function npwpLess15()
{
    const inputData = [
        {   jnsBantuan: '2', penerimaHibah: '3',
            nminstansi: 'AKATSUKI', nmpimpinan: 'PAIN OZORA',npwp: '3298989', noakta: '01/akta/2022',
            prov: '12', kab: '03', kec: '03', kel: '1098',
            alamat: 'Jl. Bojong No. 6', rt: '001', rw: '002',
            tgl_profosal: '', judul_profosal: '', latar_belakang: '', maksud_tujuan: 'success',
            dropdownBantuanBerupa: '2', uraian: 'mesin simso'
    ...
    try{
        ...
        assert.strictEqual(sweetAlertText, "NPWP Harus 15 character!");
        console.log('Test NPWP Less 15 passed...');

    }catch(error){
        console.log('Test NPWP Less 15 failed...');
        console.error("Error occurred:", error.message);
    }finally{
        await driver.sleep(3000);
        await driver.quit();
...
async function npwpMore15()
{
    const inputData = [
        {   jnsBantuan: '2', penerimaHibah: '3',
            nminstansi: 'AKATSUKI', nmpimpinan: 'PAIN OZORA',npwp: '34959687902394569790', noakta: '01/akta/2022',
            prov: '12', kab: '03', kec: '03', kel: '1098',
            alamat: 'Jl. Bojong No. 6', rt: '001', rw: '002',
            tgl_profosal: '', judul_profosal: '', latar_belakang: '', maksud_tujuan: 'success',
            dropdownBantuanBerupa: '2', uraian: 'mesin simso'
    ...
    try{
        ...
        assert.strictEqual(sweetAlertText, "NPWP Harus 15 character!");
        console.log('Test NPWP More 15 passed...');

    }catch(error){
        console.log('Test NPWP More 15 failed...');
        console.error("Error occurred:", error.message);
    }finally{
        await driver.sleep(3000);
        await driver.quit();
