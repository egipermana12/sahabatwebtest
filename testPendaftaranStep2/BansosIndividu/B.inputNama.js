...
async function namaNull()
{
    const inputData = [
        {   jnsBantuan: '1', bdnHukum: '2', jnsPenerima: '1', nik: '3202080504910009',
            nama: '', tgl_lahir: '', no_kk: '',jnsPekerjaan: '1',
    ...
    try{
        ...
        assert.strictEqual(sweetAlertText, "Nama Lengkap Penerima belum diisi!");
        console.log('Test Nama Not Null passed...');

    }catch(error){
        console.log('Test Nama Not Null Not Null failed...');
...
async function nmNonAlfabet()
{
    const inputData = [
        {   jnsBantuan: '1', bdnHukum: '2', jnsPenerima: '1', nik: '3202080504910009',
            nama: 'abdul@1!!<?php?>', tgl_lahir: '22/02/1992', no_kk: '32020805049100029',jnsPekerjaan: '1',
            prov: '12', kab: '03', kec: '03', kel: '1098',
    ...
    try{
        ...
        console.log('Test Nama Non Alfabet passed...');

    }catch(error){
        console.log('Test Nama Non Alfabet failed...');
        console.error("Error occurred:", error.message);
    }finally{
        await driver.sleep(3000);
        await driver.quit();
...
async function nmTooLong()
{
    ...
    try{
        ...
        assert.strictEqual(sweetAlertText, "Nama Penerima Terlalu Panjang");
