...
async function jnsKelNull()
{
    const inputData = [
        {   jnsBantuan: '1', bdnHukum: '2', jnsPenerima: '1', nik: '3202080504910009',
            nama: 'abdul sueb', tgl_lahir: '12/12/1992', no_kk: '32020805049100029',jnsPekerjaan: '1',
    ...
    try{
        ...
        //handle globa form
        await globalForm2(driver,inputData, false);
        ...
        console.log('Test Jns Kelamin Not Null passed...');

    }catch(error){
        console.log('Test Jns Kelamin Not Null failed...');
